...
const gameData = [
    ...
    },
    {
        ...
        downloadLinks: [
            { name: "النسخة الكاملة", url: "https://shrinkme.click/NnSi5", size: "14 GB" }
        ],
        featured: true,
        trending: true
    },
    {
        ...
        downloadLinks: [
            { name: "النسخة الكاملة", url: "https://ouo.io/LM9AeM", size: "110 GB" }
        ],
        featured: true,
        trending: true
    },
    {
        ...
        downloadLinks: [
            { name: "النسخة الكاملة", url: "https://ouo.io/klL72E", size: "500 MB" }
        ],
        featured: true,
        trending: true
    },
