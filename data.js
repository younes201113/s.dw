...
const gameData = [
    {
        ...
        screenshots: [
            "assets/games/gta5_1.jpg",
            "assets/games/gta5_2.jpg",
            "assets/games/gta5_3.jpg",
            "assets/games/gta5_4.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "الجزء 1", url: "downloads/gta5_part1.zip", size: "10 GB" },
            { name: "الجزء 2", url: "downloads/gta5_part2.zip", size: "10 GB" },
            { name: "الجزء 3", url: "downloads/gta5_part3.zip", size: "10 GB" }
        ],
        featured: true,
        trending: true
    },
    {
        ...
        screenshots: [
            "assets/games/valorant_1.jpg",
            "assets/games/valorant_2.jpg",
            "assets/games/valorant_3.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "النسخة الكاملة", url: "downloads/valorant_setup.exe", size: "20 GB" }
        ],
        featured: true,
        trending: true
    },
    {
        ...
        rating: 4.7,
        size: "2 GB",
        image: "assets/games/pubg_mobile.jpg",
        screenshots: [
            "assets/games/pubg_mobile_1.jpg",
            "assets/games/pubg_mobile_2.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "APK مباشر", url: "downloads/pubg_mobile.apk", size: "2 GB" }
        ],
        featured: true,
        trending: true
    },
    {
        ...
        rating: 4.6,
        size: "250 MB",
        image: "assets/games/clash_of_clans.jpg",
        screenshots: [
            "assets/games/clash_of_clans_1.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "نسخة Android", url: "downloads/clash_of_clans.apk", size: "250 MB" },
            { name: "نسخة iOS", url: "https://apps.apple.com/app/clash-of-clans/id529479190", size: "250 MB" }
        ],
        featured: true,
        trending: true
    },
    {
        ...
        rating: 4.9,
        size: "3 GB",
        image: "assets/programs/photoshop.jpg",
        screenshots: [
            "assets/programs/photoshop_1.jpg",
            "assets/programs/photoshop_2.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "النسخة الكاملة", url: "downloads/photoshop_2023.zip", size: "3 GB" },
            { name: "التفعيل", url: "downloads/photoshop_crack.rar", size: "50 MB" }
        ],
        featured: true,
        trending: true
    },
    {
        ...
        rating: 4.3,
        size: "3 MB",
        image: "assets/programs/winrar.jpg",
        screenshots: [
            "assets/programs/winrar_1.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "إصدار 64-bit", url: "downloads/winrar_x64.exe", size: "3 MB" },
            { name: "إصدار 32-bit", url: "downloads/winrar_x86.exe", size: "3 MB" }
        ],
        trending: true
    },
    {
        ...
        rating: 4.4,
        size: "80 MB",
        image: "assets/apps/whatsapp.jpg",
        screenshots: [
            "assets/apps/whatsapp_1.jpg"
        ],
        specs: {
            android: "Android 4.1 أو أحدث",
            ios: "iOS 10.0 أو أحدث",
        ...
        downloadLinks: [
            { name: "نسخة Android", url: "downloads/whatsapp.apk", size: "80 MB" },
            { name: "نسخة iOS", url: "https://apps.apple.com/app/whatsapp-messenger/id310633997", size: "80 MB" }
        ],
        featured: true
    },
    {
        ...
        rating: 4.2,
        size: "25 MB",
        image: "assets/apk/snaptube.jpg",
        screenshots: [
            "assets/apk/snaptube_1.jpg",
            "assets/apk/snaptube_2.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "الإصدار الأخير", url: "downloads/snaptube_latest.apk", size: "25 MB" }
        ],
        trending: true
    },
    {
        ...
        rating: 4.6,
        size: "125 GB",
        image: "assets/games/cod_warzone.jpg",
        screenshots: [
            "assets/games/cod_warzone_1.jpg",
            "assets/games/cod_warzone_2.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "النسخة الكاملة", url: "downloads/cod_warzone_setup.exe", size: "125 GB" }
        ],
        trending: true
    },
    {
        ...
        screenshots: [
            "assets/games/minecraft_1.jpg",
            "assets/games/minecraft_2.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "النسخة الكاملة", url: "downloads/minecraft_full.zip", size: "1 GB" }
        ]
    },
    {
        id: "vscode",
        ...
        rating: 4.7,
        size: "100 MB",
        image: "assets/programs/vscode.jpg",
        screenshots: [
            "assets/programs/vscode_1.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "Windows 64-bit", url: "downloads/vscode_win64.exe", size: "100 MB" },
            { name: "macOS", url: "downloads/vscode_mac.zip", size: "100 MB" }
        ]
    },
    {
        id: "spotify",
        ...
        rating: 4.5,
        size: "50 MB",
        image: "assets/apk/spotify.jpg",
        screenshots: [
            "assets/apk/spotify_1.jpg"
        ],
        specs: {
        ...
        downloadLinks: [
            { name: "Spotify Premium APK", url: "downloads/spotify_premium.apk", size: "50 MB" }
        ]
    }
];
